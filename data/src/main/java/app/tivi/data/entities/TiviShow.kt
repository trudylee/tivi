...
data class TiviShow(
    ...
    @ColumnInfo(name = "last_trakt_data_update") val traktLastUpdated: OffsetDateTime? = null,
    @ColumnInfo(name = "need_episode_update", defaultValue = "true") val needEpisodeUpdate: Boolean = true,
